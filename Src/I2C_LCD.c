...
//	HAL_I2C_Master_Transmit(&hi2c1, 0x4E, (uint8_t *)data_t, 4, 100);
	HAL_I2C_Master_Transmit(&hi2c1, SLA_W, (uint8_t *)data_t, 4, 100);
	//HAL_I2C_Master_Transmit_DMA(&hi2c1, SLA_W, (uint8_t *)data_t, 4);
//	for(uint8_t i=0;i<4;i++){
////		I2C_write_byte(SLA_W, data_t[i]);
//		HAL_I2C_Master_Transmit(&hi2c1, SLA_W, &data_t[i], 1, 100);
//	}
}
